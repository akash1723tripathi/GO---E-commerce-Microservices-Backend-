...
func (x *GetOrdersRequest) GetSkip() uint64 {
	if x != nil {
		return x.Skip
	}
	return 0
...
func (x *GetOrdersRequest) GetTake() uint64 {
	if x != nil {
		return x.Take
	}
	return 0
...
const file_order_proto_rawDesc = "" +
	...
	"\bquantity\x18\x05 \x01(\rR\bquantity\"\xc2\x01\n" +
	"\x05Order\x12\x0e\n" +
	...
	"totalPrice\x12.\n" +
	"\bproducts\x18\x05 \x03(\v2\x12.pb.OrderedProductR\bproducts\"a\n" +
	...
	"\x05order\x18\x01 \x01(\v2\t.pb.OrderR\x05order\"Y\n" +
	"\x10GetOrdersRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12\x12\n" +
	"\x04skip\x18\x02 \x01(\x04R\x04skip\x12\x12\n" +
	"\x04take\x18\x03 \x01(\x04R\x04take\"6\n" +
	"\x11GetOrdersResponse\x12!\n" +
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders2\xb9\x01\n" +
	"\fOrderService\x128\n" +
	"\tPostOrder\x12\x14.pb.PostOrderRequest\x1a\x15.pb.PostOrderResponse\x125\n" +
	"\bGetOrder\x12\x13.pb.GetOrderRequest\x1a\x14.pb.GetOrderResponse\x128\n" +
	"\tGetOrders\x12\x14.pb.GetOrdersRequest\x1a\x15.pb.GetOrdersResponseB8Z6github.com/akash1723tripathi/go-microservices/order/pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*GetOrdersResponse)(nil),     // 7: pb.GetOrdersResponse
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_order_proto_depIdxs = []int32{
	8, // 0: pb.Order.created_at:type_name -> google.protobuf.Timestamp
	0, // 1: pb.Order.products:type_name -> pb.OrderedProduct
	...
	1, // 5: pb.GetOrdersResponse.orders:type_name -> pb.Order
	2, // 6: pb.OrderService.PostOrder:input_type -> pb.PostOrderRequest
	4, // 7: pb.OrderService.GetOrder:input_type -> pb.GetOrderRequest
	6, // 8: pb.OrderService.GetOrders:input_type -> pb.GetOrdersRequest
	3, // 9: pb.OrderService.PostOrder:output_type -> pb.PostOrderResponse
	5, // 10: pb.OrderService.GetOrder:output_type -> pb.GetOrderResponse
	7, // 11: pb.OrderService.GetOrders:output_type -> pb.GetOrdersResponse
